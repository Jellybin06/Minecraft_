        ...
        extends AbilityBase
{
    public Devil()
    {
        if (PhysicalFighters.Gods) {
            InitAbility("악마", AbilityBase.Type.Active_Immediately, AbilityBase.Rank.GOD, new String[] {
    ...
    public int A_Condition(Event event, int CustomData)
    {
        if (CustomData == 0)
        {
            ...
            if (PlayerCheck(Event2.getEntity())) {
                if ((Event2.getCause() == EntityDamageEvent.DamageCause.LAVA) ||
    ...
    class Pauck extends TimerTask {
        ...
        Pauck(Player pp1, Player pp2, Location locc, Location locc2) { this.p1 = pp1;
            this.p2 = pp2;
            this.l1 = locc;
            this.l2 = locc2;
        }
